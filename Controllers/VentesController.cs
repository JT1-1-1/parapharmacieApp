...
namespace ParapharmacieApp.Controllers
{
    public class VentesController : Controller
    {
        ...
        public VentesController(ParapharmacieDbContext context)
        {
            _context = context;
        }
        ...
        {
            var parapharmacieDbContext = _context.Ventes.Include(v => v.IdClientNavigation);
        ...
        public async Task<IActionResult> Create([Bind("IdVente,DateVente,Total,Remise,IdClient")] Vente vente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdVente,DateVente,Total,Remise,IdClient")] Vente vente)
        {
            if (id != vente.IdVente)
            {
                return NotFound();
